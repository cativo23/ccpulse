...
export interface DisplayToggles {
  ...
  health: boolean;
  /**
   * When true, append a depletion ETA to the 5h rate-limit segment (e.g. `~2h15m left`).
   * Computed from elapsed time in the current 5h window and used percentage. Opt-in for
   * v1.0. See renderLine2 for gating rules.
   */
  rateLimitEta: boolean;
  /**
